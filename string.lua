    ...
    CHARACTERS = {
        ...
        WORTOX = {
            DESCRIBE = {
                ...
                PIGMAN_QUEEN = "您好，陛下。",
                PIGMAN_MAYOR = {
                    GENERIC = "是，首相。",--Yes, Prime Minister.
                    SLEEPING = "真是累死人，对吧。",
                },
        ...
        WURT = {
            DESCRIBE = {
                ...
                PIG_PALACE = "鱼人必须也有一个！！！",--Mermfolk
                PIGMAN_QUEEN = "她才不算什么女王呢，浮浪特！！",--SHe no King, flort!!对应猪王
                PIGMAN_MAYOR = {
        ...
        WANDA = {
            DESCRIBE = {
                ...
                PIGMAN_QUEEN = "一旦你深入了解，就会发现她非常冷血。",-- 对应猪王He can be reasonable enough once you get to know him."
                PIGMAN_MAYOR = {
